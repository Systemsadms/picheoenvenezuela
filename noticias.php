...
<div id="Separacion1"></div>
        ...
        <?php
                ...
                ?>
						...
						<?php
							if(isset($_POST['ancla2']))
							{
								$ancla= $_POST['ancla2'];
							}else
							{
                            require("cnx.php");
                            $ssql = mysql_query("SELECT * FROM portada WHERE seccion='$seccion'");
                            ...
                            mysql_close($conexion);
                                ...
                                $foto = $ancla."/portada.jpg";

                        ?>

					<br />
					<div id="titulos"><b><?php echo $titulo; ?></b></div>
                    <br />

                    <table width="400" border="0" align="center">
                      <tr>
                        <td><img  src="noticias/portada_<?php echo $ancla;?>.jpg" width="550px" height="350px"/></td>
                      </tr>
                    </table>
        ...
        </div> <!--FIN DE NOTICIA Y PROPAGANDA-->
