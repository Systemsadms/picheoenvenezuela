...
<h2 align="center">Noticias Nacionales</h2>
...
<?php
	include ("cnx.php");					
				...
				$consulta = "SELECT * FROM noticias WHERE tipo='Nacionales';";
				...
				echo "
				 ...
				 <div class='AccordionPanel'>
				  <div class='AccordionPanelTab'><b>".$reg[2]."</b></div>
				  ...
				  <table align='center' border='0' width='500'>
				  	<tr>
						<td align='center'>
							<img src='noticias/portada_".$reg[4].".jpg' width='500' height='300' border='0' />
						</td>
					</tr>				  	
				  </table>
				  <br>
				  ...
				  ".$reg[3]."
					...
					<br>
					<form method='post' action='noticiasNacionales2.php'>
						<table align='center'>
							<tr>
								<td>
								...
								<input type='hidden' name='galeria' value='".$reg[4]."'>
								<input type='hidden' name='titulo' value='".$reg[2]."'>
